...
export const useSpeechStore = defineStore('speech', () => {
  ...
  // State
  const activeSpeechProvider = useLocalStorageManualReset<string>('settings/speech/active-provider', 'edge-tts')
  const activeSpeechModel = useLocalStorageManualReset<string>('settings/speech/active-model', 'edge-tts')
  const activeSpeechVoiceId = useLocalStorageManualReset<string>('settings/speech/voice', 'zh-CN-XiaoxiaoNeural')
